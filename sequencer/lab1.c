...
void *fib10(void *threadp)
{
	...
	// Assume FIB_TEST short enough that preemption is minimal
...
void *Sequencer(void *threadp)
{
	...
	printf("Starting Sequencer: [S1, T1=20, C1=20], [S2, T2=50, C2=20], U=0.9, LOCM=100\n");
...
void main(void)
{
	...
	printf("systems has %d processors configured and %d available\n", get_nprocs_conf(), get_nprocs());
